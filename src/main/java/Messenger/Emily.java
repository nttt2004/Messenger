...
public class Emily implements Initializable {
    ...
    void CallButtonOnAction(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(Antifan.class.getResource("emilyCall.fxml"));
            AnchorPane gamepane = fxmlLoader.load();
            chatPane.getChildren().setAll(gamepane);
            EmilyCall antifanController = fxmlLoader.getController();
    ...
    void VideoButtonOnAction(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(Antifan.class.getResource("emilyVideo.fxml"));
            AnchorPane gamepane = fxmlLoader.load();
            chatPane.getChildren().setAll(gamepane);
            EmilyVideo antifanController = fxmlLoader.getController();
            antifanController.setChatPane(chatPane);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
